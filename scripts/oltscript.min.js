...
let numOfAdults=0;switch(adultNumSelect.options[adultNumSelect.selectedIndex].value){case "1":numOfAdults=1;break;case "2":numOfAdults=2;break;case "3":numOfAdults=3;break;case "4":numOfAdults=4;break}
return numOfAdults}
...
let checkoutMsec=checkinDate.getTime()+(stayLength*msec_per_day);document.getElementById("checkinDateOutput").value=checkinDate.toLocaleDateString();let temp=new Date(checkoutMsec);document.getElementById("checkoutDateOutput").value=temp.toLocaleDateString()}
...
return costOfRmType}
function checkRoomCompatibility(){let numOfAdults=getNumAdults();let numOfChildren=getNumChildren();let rmSelect=document.getElementById("typeOfRmSelect");if(numOfAdults+numOfChildren>6){rmSelect.options[1].style.display="none";rmSelect.options[2].style.display="none";rmSelect.options[3].style.display="none";rmSelect.options[4].style.display="none"}else if(numOfAdults+numOfChildren>5){rmSelect.options[1].style.display="none";rmSelect.options[2].style.display="none";rmSelect.options[3].style.display="none";rmSelect.options[4].style.display="block"}else if(numOfAdults+numOfChildren>4){rmSelect.options[1].style.display="block";rmSelect.options[2].style.display="none";rmSelect.options[3].style.display="none";rmSelect.options[4].style.display="block"}else if(numOfAdults+numOfChildren>2){rmSelect.options[1].style.display="block";rmSelect.options[2].style.display="none";rmSelect.options[3].style.display="block";rmSelect.options[4].style.display="block"}else{rmSelect.options[1].style.display="block";rmSelect.options[2].style.display="block";rmSelect.options[3].style.display="block";rmSelect.options[4].style.display="block"}}
function getDiscount(){let discNoneRb=document.getElementById("discNoneRb");let discAaaRb=document.getElementById("discAaaRb");let discSeniorRb=document.getElementById("discSeniorRb");let discMilitaryRb=document.getElementById("discMilitaryRb");let discAmt=0;if(discAaaRb.checked){discAmt=0.1}else if(discSeniorRb.checked){discAmt=0.1}else if(discMilitaryRb.checked){discAmt=0.2}else if(discNoneRb.checked){discAmt=0}
return discAmt}
function getBreakfastCost(){let stayLengthField=document.getElementById("stayLengthField");let stayLength=stayLengthField.value;let breakfastSwitch=document.getElementById("breakfastSwitch");let discSeniorRb=document.getElementById("discSeniorRb");let breakfastCost=0;let numOfAdults=getNumAdults();let numOfChildren=getNumChildren();if(discSeniorRb.checked&&breakfastSwitch.checked){breakfastCost=0}else if(breakfastSwitch.checked){breakfastCost=((numOfAdults*6.96)+(numOfChildren*3.95))*stayLength}else{breakfastCost=0}
